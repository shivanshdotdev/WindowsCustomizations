...
- Install the **Chai Theme** from the extension market
- After installing, go to `C:\Users\<YourUserName>\.vscode\extensions\hiteshchoudharycode.chai-theme-0.2.0\themes`
- Over-write the content of the `dark-chai.json` with the code below.
...
```json
{
  ...
  "colors": {
    ...
    "editorCursor.foreground": "#8abcdd",
    ...
    "activityBar.border": "#8abcdd",
    "activityBar.foreground": "#8abcdd",
    "activityBar.inactiveForeground": "#8abcdd",
    ...
    "tab.activeBorderTop": "#115C8E",
    "tab.activeModifiedBorder": "#0279C9",
    "tab.activeBorder": "#115C8E",
    ...
    "editor.lineHighlightBackground": "#010107",
    ...
    "terminal.selectionBackground": "#CCE5FF",
    ...
    "titleBar.activeForeground": "#8abcdd",
    "titleBar.inactiveBackground": "#424548",
